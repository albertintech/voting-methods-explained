...
Each article builds on the previous one, moving from simple to complex voting systems. The goal of this series is to help readers develop a mental toolkit that can be used to intelligently consider voting methods, their design spaces, and real-world applications.
...
3. **Ranked Choice Voting: How It Works** -- Ranked ballots, elimination, and transfers
4. **Ranked Choice Voting: Structural Consequences** -- Center squeeze, monotonicity, and ballot exhaustion
5. **Approval Voting** -- A different way to express preference
6. **Score Voting** -- Measuring degrees of support
...
This site is built with [mdBook](https://rust-lang.github.io/mdBook/) and deployed via GitHub Pages.
